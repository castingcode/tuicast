...
examples/
  ...
  java/               Java 21 reference tests and Cucumber bindings
  python/             Python 3.12 reference tests and Cucumber bindings
  typescript/         Node.js 24 reference tests and Cucumber bindings
```
...
Each language demonstrates form and table workflows, stable waits for partial
...
Every binding attaches a rendered terminal capture after changed outcome
screens and immediately after failures. CI publishes these captures in
language-specific Cucumber HTML reports. See
[`design/cucumber.md`](../design/cucumber.md) for the feature-writing, lifecycle,
capture, and reporting conventions.
